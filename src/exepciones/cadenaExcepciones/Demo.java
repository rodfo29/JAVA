...
public class Demo {
    ...
    public static void verificarEdad(int edad)   throws UserException { // Si queremos lanzar una exeption comprobada debemos indicar el tipo de exeption que vamos a mandar.


        if (edad<0){
            throw new UserException(new EdadInvalidaException()); // Creamos una instancia de la clase encargada de contener a las demás
        }
